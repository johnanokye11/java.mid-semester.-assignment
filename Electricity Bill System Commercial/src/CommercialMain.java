...
System.out.print("Enter Connection Type: ");
 ...
 CommercialElectricityBill bill = new CommercialElectricityBill(consumerNo, consumerName, prevReading, currentReading, connectionType);
   		 
       // Displaying the bill amount
 
System.out.println("\nCommercial Electricity Bill for Mr/Mrs " + consumerName + "(Consumer No:" + consumerNo +")");
